  ...
  return (
    <section className="lg:col-span-7 flex flex-col justify-center pr-0 lg:pr-8" data-purpose="hero-presentation">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div className="w-10 h-10 rounded-xl bg-brand-600 flex items-center justify-center shadow-md shadow-brand-600/25 text-white font-bold text-xl">
          {orgName ? orgName.charAt(0) : 'F'}
        </div>
        <span className="text-2xl font-bold tracking-tight text-surface-dark">{orgName || 'FinanceManage'}</span>
