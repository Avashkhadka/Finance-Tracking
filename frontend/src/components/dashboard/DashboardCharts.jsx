...
export default function DashboardCharts({ transactions = [] }) {
  ...
  const sortedMonths = Object.keys(monthlyStats).sort().slice(-6); // last 6 months
      ...
      <div className="lg:col-span-8 bg-white rounded-xl p-6 border border-slate-200 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center p-0.5 rounded-lg bg-slate-100 border border-slate-200/80 self-start sm:self-auto">
            <button className="px-3 py-1 text-xs font-medium text-slate-600 hover:text-slate-900 rounded-md transition-colors" type="button">1M</button>
            <button className="px-3 py-1 text-xs font-semibold text-indigo-700 bg-white shadow-sm rounded-md" type="button">3M</button>
            <button className="px-3 py-1 text-xs font-medium text-slate-600 hover:text-slate-900 rounded-md transition-colors" type="button">6M</button>
            <button className="px-3 py-1 text-xs font-medium text-slate-600 hover:text-slate-900 rounded-md transition-colors" type="button">1Y</button>
          </div>
        </div>
        {/*  Clean Legend  */}
