            ...
            <div className="lg:col-span-4 bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden flex flex-col self-start">
              ...
              <form className="p-6 space-y-5" onSubmit={handleAddFiscalYear}>
                ...
                <div>
                  ...
                  <input className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all" id="start_date" name="start_date" required type="date"/>
                </div>
                ...
                <div>
                  ...
                  <input className="w-full px-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:ring-2 focus:ring-brand-500 focus:border-brand-500 transition-all" id="end_date" name="end_date" required type="date"/>
                </div>
